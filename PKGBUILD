# $Id: PKGBUILD 292114 2017-04-05 12:13:55Z tpowa $
# Maintainer: Tobias Powalowski <tpowa@archlinux.org>
# Maintainer: Thomas Baechler <thomas@archlinux.org>

#pkgbase=linux               # Build stock -ARCH kernel
pkgbase=linux-fx553vd        # Build kernel with FX553VD patches
_srcname=linux-4.12.4
pkgver=4.12.4
pkgrel=1
arch=('i686' 'x86_64')
...
sha256sums=('f470d75f1f5a375f6882958daf96e7f8552fff28702b70abf3744e1711ef5ac9'
            ...
            '9b8e9b3364751781c02f347828a7f81876611d9203f5fa30290b7e3f111030d6'
...
prepare() {
  ...
  msg "applying FX553VD's patches."
  patch -d "drivers/hid" -p0 -i "${srcdir}/kbd-backlight.patch" --ignore-whitespace
